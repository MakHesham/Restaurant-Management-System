...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        p1.add(l1);
         ...
         p2.setLayout(null);
         p2.setBounds(435,0,460,700);
         add(p2);
         
        JLabel l2 = new JLabel("Username");
	l2.setBounds(60, 125, 100, 25);
         l2.setForeground(Color.BLACK);
        l2.setFont(new Font("SAN_SERIF",Font.PLAIN, 20));
	p2.add(l2);
        
        t1 = new JTextField();
        t1.setBounds(60,165,300,30);
        t1.setBorder(BorderFactory.createEmptyBorder());
        p2.add(t1);
        
        
        JLabel l3 = new JLabel("Password");
	l3.setBounds(60, 215, 100, 25);
        l3.setFont(new Font("SAN_SERIF",Font.PLAIN, 20));
	p2.add(l3);
        
        t2 = new JPasswordField();
        t2.setBounds(60,255,300,30);
        t2.setBorder(BorderFactory.createEmptyBorder());
        p2.add(t2);
        
        b1 = new JButton("Login");
        b1.setBounds(60,310,130,30);
